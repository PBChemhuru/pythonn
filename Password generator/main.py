...
def passwordgenerate():
    ...
    text_box = Text(window, height=2, width=40)
...
labelword1 = Label(window, text="Numbers:").grid(row=2, column=0)
...
labelword3 = Label(window, text="Symbols :").grid(row=4, column=0)
